          ...
          <Grid item xs={12} md={8}>
            <div className="mdm:p-8 smm:p-6 p-4 bg-white shadow-md h-full rounded-md gap-6 flex-col flex">
              <div className="flex justify-between items-center ">
                <p className="font-semibold text-[24px]">Confirmation</p>
              </div>

              <div className="bg-white shadow-md p-8 flex flex-col gap-4 rounded-md ">
                <div className="flex justify-between">
                  <p className="font-medium text-[16px]">Customer Information</p>
                  <p className="text-[#E51B48] font-normal">Edit</p>
                </div>
                <div>
                  <p className="text-[#515151] font-normal">
              ...
              <div className="bg-white shadow-md p-8 flex flex-col gap-4 rounded-md ">
                <div className="flex justify-between">
                  <p className="font-medium text-[16px]">Shipment Information</p>
                  <p className="text-[#E51B48] font-normal">Edit</p>
                </div>
                <div>
                  <p className="text-[#515151] font-normal">
