      ...
      <div className="px-20 py-10 w-[90%] mx-auto mb-10 bg-white rounded-lg">
        ...
        <div className="flex flex-row gap-10 my-20">
          <div className="flex flex-col gap-10 w-1/2">
            <div>
              <h1 className="text-[40px] font-[500]">Transaction Pin</h1>
              <p className="font-normal text-[#515151]">Create a pin for your transactions</p>
            </div>
            <div>
          ...
          <div className="px-10 py-6 w-1/2 flex flex-col gap-8 bg-white rounded-md border">
            <div className="flex flex-col gap-4">
              <div className="flex justify-between">
                <p className="font-medium text-[24px]">Create Pin</p>
              </div>

              <div className="flex gap-[8px] justify-center">
                <div>
                  <p className="text-[#515151] font-normal text-[14px]">Input pin</p>
                  <PinCode codeLength={4} onCodeComplete={setCode} />
                </div>
              </div>
              <div className="flex gap-[8px] justify-center">
                <div>
                  <p className="text-[#515151] font-normal text-[14px]">Confirm pin</p>
                  <PinCode codeLength={4} onCodeComplete={setCode} />
                </div>
              </div>
            </div>

            <button className="bg-[#E51B48] text-white w-full p-2 rounded-md mt-20">Create Pin</button>
          </div>
        </div>
      </div>
