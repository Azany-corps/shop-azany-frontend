...
const AuthLogin = () => {
  ...
  return (
    <div className="bg-[#F5F5F5] xs:h-screen ">
      <ToastContainer />
      <div className="flex xs:flex-col-reverse sm:flex-col-reverse md:flex-col-reverse xl:justify-between sm:flex-col 2xl:justify-between xl:h-screen">
        ...
        <div className="relative xl:w-3/4">
          <img src="/images/loginbanner.jpg" alt="" className="xs:max-h-20 sm:max-h-40 h-screen w-full md:max-h-40 object-cover" />
