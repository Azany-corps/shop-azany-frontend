...
const Buy = ({ orders, setOrderStatus }: { orders: Array<IOrder>, setOrderStatus: Function }) => {
                ...
                <div className="flex smm:gap-3 gap-2 flex-col smm:p-4 px-2 py-64rounded-[10px] shadow-md sha bg-white">
                  ...
                  <div className="flex items-center py-1 relative justify-between">
                    ...
                    <div className="flex absolute -top-4 right-1">
                      <button className="bg-transparent px-6 py-[0.6rem] text-base text-black">Return Item</button>
                      <button className="bg-[#FFD700] rounded-lg px-6 py-[0.6rem] text-base text-black">Add Review</button>
                    </div>
                  </div>
                </div>
              )
