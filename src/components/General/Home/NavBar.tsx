...
const NavBar = () => {
    return (
        <div className='hidden md:flex flex-col md:flex-row bg-white relative w-full justify-between gap-4 px-4 md:px-12 py-2 items-center'>
            <div className=" hidden md:flex items-center gap-2 font-semibold">
                <Icon icon="ion:menu" width="24" color='black' />
                <span className=''>Categories</span>
            </div>
            <ul className='flex overflow-x-scroll no-scrollbar gap-6 md:gap-12 items-center'>
                <li className='text-sm w-full font-semibold '>Worldwide flex card</li>
            ...
            <div className="flex justify-start gap-4 h-full relative items-center">
