...
const NavBar = () => {
    return (
        <div className='hidden md:flex flex-col md:flex-row bg-white relative justify-between gap- px-4 md:px-12 py-2 items-center'>
            ...
            <div className="flex w-full justify-start gap-4 h-full relative items-center">
