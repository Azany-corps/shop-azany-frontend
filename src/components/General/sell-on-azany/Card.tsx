...
const CardSOA = ({ price, module, recommended, onClick, selected }: CardSOAProps) => {
  return (
    <div onClick={onClick} className={`w-[340px] xs:w-[280px] h-[362px] flex flex-col gap-4 p-4 rounded-md ${selected ? "bg-blue-400 text-white" : "bg-white"}`}>
      {recommended && (
